...
def main(_):
  ...
  with tf.variable_scope("posterior"):
    with tf.variable_scope("qW_0"):
      loc0 = tf.get_variable("loc", [2, 2], initializer=tf.constant_initializer(-30))
    ...
    with tf.variable_scope("qW_1"):
      loc1 = tf.get_variable("loc", [2, 2], initializer=tf.constant_initializer(8))
    ...
    with tf.variable_scope("qW_2"):
      loc2 = tf.get_variable("loc", [2, 1], initializer=tf.constant_initializer(18))
